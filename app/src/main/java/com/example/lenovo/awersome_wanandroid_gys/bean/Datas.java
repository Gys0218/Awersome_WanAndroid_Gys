...
public class Datas {
    ...
    private Long publishTime; //todo int类型
    ...
    public Datas(String apkLink, String author, int chapterId, String chapterName, boolean collect, int courseId, String desc, String envelopePic, boolean fresh, int id, String link, String niceDate, String origin, String projectLink, Long publishTime, int superChapterId, String superChapterName, ArrayList<Tags> tags, String title, int type, int userId, int visible, int zan) {
